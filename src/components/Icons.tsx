...
export const BananaIcon = ({
  ...
  solid = true,
  ...props
}: React.SVGProps<SVGSVGElement> & { solid?: boolean }) => (
  <svg
    viewBox="0 0 24 24"
    ...
    {...props}
  >
    {/* Whole banana (body + stem) fitted inside the 24x24 box so nothing clips. */}
    ...
    <path d="M4 13c3.5-2 8-2 10 2a5.5 5.5 0 0 1 8 5" fill="none" strokeWidth="1.8" />
  </svg>
);
